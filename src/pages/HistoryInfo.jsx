        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div className="flex w-full items-center justify-center flex-column flex-wrap space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900 pt-10">
                ...
                <div className="relative">
                    ...
                    <input onChange={onChange} value={search} type="text" id="table-search" className="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar miembros" />
                </div>
            </div>
